...
//        Icon(name: "Air pressure  ", icon: "cloud.fog", color1: Color.white, color2: Color.red, color3: Color.red, minValue: 100000, maxValue: 102000, color1Position:0.2, color3Position:0.8, measurement:"bme", type:"7", identifier:"sensor_id"), /// both pressure and gas is sensor_id 7????
    ...
    static let sensorAirQuality = [
        ...
        Icon(name: "CO2\n(nose)", icon: "carbon.dioxide.cloud", color1: Color.white, color2: Color.yellow, color3: Color.red, minValue: 300.0, maxValue: 1500.0, color1Position:0.25, color3Position:0.58, unit: "", measurement:"bme", type:"3", identifier:"sensor_id", meaning: "The equivalent CO2 here indicates the CO2 level around your face. Below 600 shows a good condition for your well-being. High CO2 levels, generally over 1000 ppm, indicate a potential problem with air circulation and fresh air in a room or building. Higher CO2 (color coded in yellow-red) concentrations can have negative impact on your overall well-being, health, and cognitive skills. Increase ventilation with clean air is recommanded in such situations. This equivalent CO2 is measured on the nose bridge of the glasses, indicating the condition of your own inhalation of the air."),
